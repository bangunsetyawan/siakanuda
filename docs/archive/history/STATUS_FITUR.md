...
> **Versi:** v1.11.2 | **Tanggal:** 19 Juni 2026 | **Total Commit:** 198
...
| **Commit Terakhir** | v1.11.2 — refactor PKL NISN identifier, append photo links to WA broadcast, remove testing mode, clean dummy data, and update temp gitignore |
...
| `feat` | ~104 | Fitur baru |
| `fix` | ~44 | Perbaikan bug |
| `docs` | ~29 | Dokumentasi |
| `chore` | ~13 | Maintenance |
...
|---|------|---------|-------------|
| 1 | `HEAD` | 19 Jun | chore(v1.11.2): refactor PKL NISN identifier, append photo links to WA broadcast, remove testing mode, clean dummy data, and ignore temp files |
| 2 | `b801095` | 19 Jun | chore: pembaruan dokumentasi, arsip, dan ignore temp files |
| 2 | `5fed973` | 19 Jun | fix: atasi tampilan guru pembimbing kosong dan label ketua salah pada cetak laporan |
| 3 | `8e5f03c` | 18 Jun | fix: atasi error Mixed Content HTTPS pada fetch JS import Excel |
| 4 | `97c906e` | 18 Jun | feat: tambahkan halaman Pusat Bantuan (Mobile WebView) & SOP Patch Update |
| 5 | `b44aca9` | 18 Jun | docs, UI, & PWA (v1.11.1): update deployment info, hamburger menu label, and manifest sizes |
| 6 | `a0f208a` | 18 Jun | feat(v1.11.1): tambah favicon, web manifest, dan PWA meta tags — icon muncul di Home Screen HP |
| 7 | `ef9a10f` | 18 Jun | docs(v1.11.1): tambah README GitHub profesional + perbaiki .gitignore untuk public repo |
| 8 | `88f18d8` | 18 Jun | docs(v1.11.1): tambah SOP deploy, troubleshooting guide, dan health-check script |
| 9 | `8bc05fc` | 18 Jun | fix(v1.11.1): Socket.io & API frontend auto-detect origin untuk production Nginx proxy |
| 10 | `05c5493` | 18 Jun | fix(v1.11.1): perbaiki Supabase auth state (createClient) & banner versi dinamis |
| 11 | `810c947` | 18 Jun | chore(v1.11.1): sinkronisasi versi & dokumentasi + perbaikan akses role guru |
| 12 | `d5bda89` | 15 Jun | feat(v1.11.1): revisi cetak rekap absensi individu (PDF 5 Bulan gabung), perbaiki bug startYear, dan sinkronisasi nama ketua dengan nomor HP |
| 13 | `bdd17e6` | 15 Jun | feat(v1.9.1): Penambahan halaman web darurat offline Cloudflare Pages dan revisi panduan deployment SSH di AGENTS.md |
| 14 | `4f65507` | 15 Jun | chore(v1.11.0): finalisasi Cloudflare Tunnel, domain DigitalPlat, shortlink s.id, reorganize archives, clean git tree |
| 15 | `94b40f2` | 14 Jun | chore: deploy success, reorganize archives, update docs, clean git tree |
| 16 | `2dcf46b` | 14 Jun | docs(v1.10.4): integrasi skenario E2E Playwright dan update STATUS_FITUR |
| 17 | `3521466` | 14 Jun | feat(v1.10.3): tambah link Profil & Ganti Password di navbar dan sidebar untuk semua role |
| 18 | `9037de7` | 13 Jun | chore: reorganisasi arsip - simpan legacy PDF script (rename detection) |
| 19 | `afcaac7` | 13 Jun | feat(v1.10.2): pisahkan data KBM dan PKL pada dashboard analytics & ubah grafik tren harian PKL |
| 20 | `a370c0b` | 13 Jun | feat(v1.10.1): perluas tracker rekapitulasi KBM menjadi 30 hari |
| 21 | `64bf44d` | 13 Jun | feat(v1.10.1): tambah tracker rekapitulasi 7 hari absensi kelas KBM |
| 22 | `8ed2cef` | 13 Jun | docs(v1.10.0): centang tugas ubah foto PKL menjadi per kelompok |
| 23 | `c56100a` | 13 Jun | chore(v1.10.0): remove legacy pdf-lib and pdfkit dependencies |
| 24 | `6ff5ed0` | 13 Jun | feat(v1.10.0): hapus PDF realtime PKL & migrasi cetak absensi KBM ke Web View HTML |
| 25 | `b810b04` | 12 Jun | feat(pkl): migrasi arsitektur PDF ke HTML & update UI foto kelompok (v1.10.0) |
...
> Terakhir diperbarui: **19 Juni 2026** oleh Antigravity Agent.
