    ...
    <div class="container-fluid d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div class="d-flex align-items-center" style="gap: 10px;">
            <?php if (in_array($userRole, ['admin', 'kepsek'])): ?>
                <button type="button" class="btn btn-warning font-weight-bold" data-toggle="modal" data-target="#pklSettingsModal">
                        ...
                        <?php $i = 1; foreach ($reports as $report): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php endif; ?>
                                    <small class="text-secondary"><i class="fas fa-user-tie mr-1"></i>Ketua: <?= htmlspecialchars($report['ketua_phone']) ?></small>
                                </td>
...
function showReportDetail(report) {
    ...
    if (report.status_libur == 1) {
        ...
        if (locContainer) {
            ...
            locData.textContent = report.location_data ? report.location_data : 'Tidak dicantumkan';
        }
